...
export class UtilisateurApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for etabUAI.
   *
   * @param {any} id utilisateur id
   *
   * @param {any} fk Foreign key for etabUAI
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdEtabUAI(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/utilisateurs/:id/etabUAI/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for etabUAI.
   *
   * @param {any} id utilisateur id
   *
   * @param {any} fk Foreign key for etabUAI
   ...
   * This method returns no data.
   */
  public destroyByIdEtabUAI(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/utilisateurs/:id/etabUAI/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for etabUAI.
   *
   * @param {any} id utilisateur id
   *
   * @param {any} fk Foreign key for etabUAI
   ...
   * </em>
   */
  public updateByIdEtabUAI(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/utilisateurs/:id/etabUAI/:fk";
    let _routeParams: any = {
  ...
  /**
   * Queries etabUAI of utilisateur.
   *
   * @param {any} id utilisateur id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getEtabUAI(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/utilisateurs/:id/etabUAI";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in etabUAI of this model.
   *
   * @param {any} id utilisateur id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createEtabUAI(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/utilisateurs/:id/etabUAI";
    let _routeParams: any = {
  ...
  /**
   * Deletes all etabUAI of this model.
   *
   * @param {any} id utilisateur id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteEtabUAI(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/utilisateurs/:id/etabUAI";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countEtabUAI(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/utilisateurs/:id/etabUAI/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyEtabUAI(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/utilisateurs/:id/etabUAI";
    let _routeParams: any = {
