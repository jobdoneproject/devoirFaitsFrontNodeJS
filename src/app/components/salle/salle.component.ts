...
export class SalleComponent implements OnInit {
    ...
    updateList() {
        this.currentUser = this.userService.getCachedCurrent();
        this.roomsv.getAll(this.currentUser.numero_uai).subscribe(
            (data: Room[]) => {
                this.allSalles = data;
            }
        );
    ...
    createSalle(nom: String) {
        ...
        if (!this.checkDoublon(nom)) {
            this.roomsv.createNew(this.currentUser.numero_uai, nom)
                .subscribe(data => {
                    // console.log("data");
                    // console.log(data);
                    this.updateList();
    ...
    deleteSalle(salle: Room) {
        this.roomsv.deleteSelected(this.currentUser.numero_uai, salle.idSalle)
            .subscribe(data => {
                // console.log(data);
                this.updateList();
